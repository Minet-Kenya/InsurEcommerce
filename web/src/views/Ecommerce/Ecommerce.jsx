        ...
        >
            <div className="pagetitle z-0">
                ...
                <nav>
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item">
                            <a href="{% url 'retail' %}">Home</a>
                        </li>
                        <li className="breadcrumb-item active">Individual Solutions</li>
                    </ol>
                </nav>
            </div>
            <section
            ...
            >
                <div className="row g-4 h-100">
                    <div
                        className="col-4 col-sm-3 col-xl-2 d-flex justify-content-center align-items-center"
                        data-aos="fade-up"
                        data-aos-delay="200"
                    >
                        <a
