...
export function Landing() {
  ...
  return (
    <>
      <main
        id="landing"
        className="landing flex-grow-1 mheader container-fluid"
      >
        <section
          className="h-100 row d-flex align-items-center justify-content-center ps-5"
          data-aos="zoom-in"
        >
          <div className="col-12 col-md-4 d-grid gap-4">
            ...
            <p>
              Minet is a trusted pan-African advisor that meets the
              uncertainties of tomorrow by delivering risk and human capital
              solutions today.
            </p>
            <div>
              ...
              <Link className="btn mt-2" to="/ecommerce">
                Get Started
              </Link>
            </div>
          </div>
          <Swiper
            className="col-md-8 swiper d-none d-md-block position-relative"
...
export function Contact() {
  ...
  return (
    <>
      <main
        id="contact"
        className="contact flex-grow-1 mheader position-relative container-fluid"
      >
        <section
          className="h-100 row gy-2 d-flex align-items-center justify-content-center py-4"
          data-aos="fade-in"
        >
            ...
            <div className="row gy-4">
              ...
              <div className="col-6">
                <div className="info-box card">
                  ...
                  <h3>Call Us</h3>
                  <p>
                    <a href="tel:+254719044000" className="link-dark">
                      +254 071 904 4000
                    </a>
                  </p>
                </div>
              ...
              <div className="col-6">
                <div className="info-box card">
                  ...
                  <p>
                    <a
                      href="mailto:retailsales@minet.co.ke"
                      className="link-dark"
                    >
                      retailsales@minet.co.ke
                    </a>
                    <br />
                    <a href="mailto:info@minet.com" className="link-dark">
                      info@minet.com
                    </a>
                  </p>
                </div>
