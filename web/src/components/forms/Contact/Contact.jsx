...
export default function ContactForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!form.checkValidity()) {
            ...
            try {
                ...
                // Fetch company info
                const response = await fetch('http://127.0.0.1:8000/base/company-info/');
                if (!response.ok) {
                ...
                const sendMailResponse = await fetch('http://127.0.0.1:8000/contact/send-mail/', {
                    method: 'POST',
                    body: formData
                });
    ...
    return (
        <>
            <form onSubmit={handleSubmit} method="post" id="contactform" className="contactform" noValidate>
                <div className="my-2">
                ...
                <div className="row gy-4">
                    ...
                    <div className="col-6 ">
                        <input type="email"
                            ...
                            required />
                        <div className="invalid-feedback email-feedback">Enter a valid email</div>
                    </div>
                    ...
                    <div className="col-md-12 text-center">
                        <button className="btn btn-primary" disabled={loading}>Send Message</button>
                    </div>
                </div>
            </form>
        </>
