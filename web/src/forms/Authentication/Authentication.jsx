...
export function LoginForm() {
    return (
        <>
            <form id="loginform" className="row g-3"
                method="post"
                action=""
                noValidate>
                ...
                <div className="col-12 btns d-flex flex-column flex-sm-row justify-content-center align-items-center">
                    ...
                    <Link to="/" className="d-block d-sm-none btn btn-primary text-white text-uppercase w-100 ms-sm-4">Back to Home</Link>
                </div>
            </form>
        </>
    );
...
export function SignupForm() {
    return (
        <>
            <form id="signupform" className="row g-3"
                method="post"
                action=""
                noValidate>
                <div className="mt-2 loading text-center d-none">
                ...
                <div className="mt-2 alert alert-success text-center d-none"></div>
                <div className="col-12 form-floating mt-3">
                    <input type="text" name="email" id="signup_email" className='form-control' placeholder='name@example.com' required autoFocus />
                    <label htmlFor="signup_email">Your Email</label>
                    <div className="invalid-feedback">Please enter a valid email</div>
                </div>
                <div className="col-12 form-floating mt-3">
                    <input type="password" name="password" id="signup_password" className="form-control" placeholder='Your password' autoComplete='current-password' required />
                ...
                <div className="col-12 btns d-flex flex-column flex-sm-row justify-content-center align-items-center">
                    <button type="submit" className="btn btn-primary text-white text-uppercase w-100 mb-3 mb-sm-0">Sign up</button>
                    <Link to="/" className="d-block d-sm-none btn btn-primary text-white text-uppercase w-100 ms-sm-4">Back to Home</Link>
                </div>
            </form>
        </>
